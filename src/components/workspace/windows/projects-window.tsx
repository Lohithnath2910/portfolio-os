...
export function ProjectsWindow() {
  return (
    <div className="flex h-[calc(100%-57px)] min-h-0 flex-col overflow-hidden">
      <div className="shrink-0 px-[clamp(1.5rem,2.2cqi,3rem)] pt-[clamp(1.5rem,2.2cqi,2.5rem)]">
        <div className="max-w-160 pb-6">
          ...
          <p className="mt-6 max-w-2xl text-[clamp(0.92rem,1.05cqi,1rem)] leading-[1.85] text-zinc-400">
            The registry below is the first layer of the projects system:
            typed, reusable, and ready to grow into dedicated project windows
            with screenshots, architecture sections, and expandable detail
            views.
          </p>
        </div>
      </div>
      ...
      >
        <div className="grid content-start gap-4 px-[clamp(1.5rem,2.2cqi,3rem)] pb-6 pr-3 lg:grid-cols-2">
          {projectRegistry.map((project) => (
            ...
            >
              ...
              <p className="mt-4 text-[0.92rem] leading-[1.75] text-zinc-400">
                {project.summary}
              </p>
